...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { id: 'categories', label: 'Categories', icon: BarChart3, path: '/admin/categories' },
    { id: 'tags', label: 'Tags', icon: Tag, path: '/admin/tags' },
    { id: 'users', label: 'Users', icon: Users, path: '/admin/users' },
    { id: 'posts', label: 'Posts', icon: Package, path: '/admin/posts' },
          ...
          <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 items-center justify-center px-2 lg:ml-6 lg:justify-start">
              <div className="w-full max-w-lg lg:max-w-xs">
                <div className="relative">
                  ...
                  <motion.input
                    className="block w-full rounded-lg border border-indigo-500/20 bg-slate-800/50 py-2 pr-3 pl-10 text-sm placeholder-gray-400 focus:border-indigo-500/40 focus:ring-1 focus:ring-indigo-500/40 focus:outline-none"
                    placeholder="Search..."
                    type="search"
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={userMenuRef}>
                <motion.button
                  className="flex items-center space-x-2 rounded-lg py-2 pl-2 text-gray-400 hover:bg-indigo-500/10 hover:text-indigo-300"
