...
import { Github, Linkedin, Mail, Phone, MapPin, Plane, Book, Music, Coffee, Code, Volleyball } from 'lucide-react'
...
const ResumeViewExporter = forwardRef((_, ref) => (
  <div className="relative min-h-screen overflow-hidden bg-slate-950" ref={ref}>
