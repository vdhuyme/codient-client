        ...
        <div className="relative z-10 container mx-auto max-w-4xl px-4 py-12">
          ...
          <div className="space-y-8">
            ...
            <motion.article
              ...
              className="prose prose-invert prose-indigo scrollbar-hide max-w-full overflow-x-auto rounded-lg border border-indigo-500/20 bg-slate-900/50 p-6 font-sans break-words text-gray-400 backdrop-blur-sm [&_.ql-code-block]:min-w-full [&_.ql-code-block]:text-sm [&_.ql-code-block]:leading-relaxed [&_.ql-code-block]:break-words [&_.ql-code-block]:whitespace-pre [&_.ql-code-block-container]:mb-4 [&_.ql-code-block-container]:overflow-x-auto [&_.ql-code-block-container]:rounded-md [&_.ql-code-block-container]:bg-slate-800 [&_.ql-code-block-container]:p-4 [&_.ql-code-block-container]:font-mono [&_.ql-code-block-container]:text-indigo-300 [&_.ql-ui]:hidden [&_a]:text-blue-400 [&_a:hover]:text-blue-500 [&_blockquote]:my-4 [&_blockquote]:rounded-md [&_blockquote]:border-l-4 [&_blockquote]:border-indigo-500 [&_blockquote]:bg-indigo-500/5 [&_blockquote]:p-4 [&_blockquote]:pl-4 [&_blockquote]:text-slate-300 [&_blockquote]:italic [&_img]:max-w-full [&_img]:rounded-md [&_pre]:break-words [&_table]:block [&_table]:border-collapse [&_table]:overflow-x-auto [&_table_td]:p-2 [&_table_th]:bg-slate-800 [&_table_th]:p-2 [&_table_th]:font-semibold [&_table_th]:text-slate-200"
