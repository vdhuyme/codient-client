          ...
          <div className="space-y-8">
            ...
            <div className="ql-snow">
              <motion.article
                ...
                className="prose prose-invert prose-indigo scrollbar-hide ql-editor max-w-full overflow-x-auto rounded-lg border border-indigo-500/20 bg-slate-900/50 p-6 font-sans break-words text-gray-400 backdrop-blur-sm"
